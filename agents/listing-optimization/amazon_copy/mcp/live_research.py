...
from amazon_copy.mcp.live_research_call import (
    ToolCallSpec,
    call_tool_best_effort,
    input_schema_json,
    output_schema_json,
)
from amazon_copy.mcp.live_research_data import build_research_bundle, normalize_tool_payload
...
async def fetch_live_mcp_research(
    ...
    *,
    ...
    """
    from amazon_copy.mcp.sif_research import research_sif_endpoint  # noqa: PLC0415
